...
export default function YourNext3({ tasks, profiles }: YourNext3Props) {
  ...
  return (
    <div className="rounded-xl overflow-hidden" style={{ background: '#fff', border: '1px solid #E8E2D6' }}>
      ...
      >
        ...
        <span className="text-[12px] font-semibold px-2.5 py-1 rounded-full" style={{ background: '#E8F1EE', color: '#1E6B5E' }}>
          {tasks.length} tasks
        </span>
      </div>
